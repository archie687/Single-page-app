      ...
      <div className="home-nav">
        <div className="first-sec">
          <div className="emai-and-sun">
            ...
            <p className="email-text">archieparliya687@gmail.com</p>
          </div>
        ...
        <div className="second-sec">
          <a
            href="https://github.com/archie687"
            target="_blank"
          ...
          <div className="shelf">
            ...
            <p className="email-text">Shelf</p>
          </div>
        </div>
      </div>
        ...
        <div className="left">
          ...
          <div className="home-left-bottom">
            <div className="first">
              ...
              <p className="home-left-bottom-first">
            ...
            <div className="scnd">
              &lt;Coder&gt;
              <p className="home-left-bottom-scnd">
                Frontend developer who writes clean and efficient code.
              </p>
            </div>
          </div>
        </div>
